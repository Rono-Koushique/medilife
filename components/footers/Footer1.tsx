...
export default function Footer1() {
    return (
        <div className="w-full bg-black full-bleed text-white">
            <div className="flex w-full py-14 items-center">
                ...
                <div className="flex flex-col flex-grow space-y-4">
                    ...
                    <p className="font-opens text-sm max-w-md font-extralight tracking-wide">
                        Filter out the noise and nurture your inbox with health
                        and wellness advice that’s inclusive and rooted in
                        medical expertise.
                    </p>
                    <Newsletter />
                    <p className="font-opens text-sm max-w-md font-extralight tracking-wide">
                        Your <span className="text-cyan-300">privacy</span> is
                        important to us
                    </p>
                </div>
